...
number_of_deauth_packets = raw_input("""How many deauth packet you want to be sent?
 (0 will put no limit and will keep deauthenticating the client until you exit, we suggest that you use 2 or 4):""")
...
print colored(
    "Thanks, I will kick the client out of his network so when he connect back we will capture the handshake he made with the router, after we tell you this is done wait about 10 seconds and a message should appear on the first terminal telling you: WPA Handshake: '+bssid+' ,in nothing appeared proceed try deauthenticating another client",
    "green")
